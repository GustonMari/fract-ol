...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/24 17:22:30 by gmary             #+#    #+#             */
/*   Updated: 2022/01/24 17:44:50 by gmary            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_gustave(t_ptr *pgm, int n, int col)
{
	double	c_cp;
	double	c_re;
	double	y;
